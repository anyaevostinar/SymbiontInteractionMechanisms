...
cd /Accounts/vostinar/SymbiontInteractionMechanisms/Data/8-22-25-StressNoDiff
...
cp /Accounts/vostinar/SymbiontInteractionMechanisms/Data/8-22-25-StressNoDiff/SymSettings.cfg .
