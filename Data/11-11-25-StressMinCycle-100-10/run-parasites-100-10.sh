...
cd /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/11-11-25-StressMinCycle-100-10
...
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/11-11-25-StressMinCycle-100-10/SymSettings.cfg .
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Parasites-100-10 -HOST_MIN_CYCLES_BEFORE_REPRO 100 -SYM_MIN_CYCLES_BEFORE_REPRO 10"
