...
mkdir Parasites200Safe1000
cd Parasites200Safe1000
...
args=" -START_MOI 1 -FILE_NAME _Parasites200Safe1000 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 1.0 -SAFE_TIME 1000 -DATA_INT 10 -UPDATES 100000 -EXTINCTION_FREQUENCY 200"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites200safe1000.sh