...
mkdir Parasites150Safe1000
cd Parasites150Safe1000
...
args=" -START_MOI 1 -FILE_NAME _Parasites150Safe1000 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 1.0 -SAFE_TIME 1000 -DATA_INT 10 -UPDATES 100000 -EXTINCTION_FREQUENCY 150"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites150safe1000.sh