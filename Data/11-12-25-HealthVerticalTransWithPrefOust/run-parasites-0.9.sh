...
cd /Accounts/zhange2/SymbiontInteractionMechanisms/Data/11-12-25-HealthVerticalTransWithPrefOust
mkdir Parasites-0.9
cd Parasites-0.9
...
cp /Accounts/zhange2/SymbiontInteractionMechanisms/Data/111-12-25-HealthVerticalTransWithPrefOust/SymSettings.cfg .
cp /Accounts/zhange2/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Parasites-0.9 -VERTICAL_TRANSMISSION 0.9"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-0.9.sh