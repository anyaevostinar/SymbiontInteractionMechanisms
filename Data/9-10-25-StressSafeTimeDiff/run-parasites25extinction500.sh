...
mkdir Parasites25extinction500
cd Parasites25extinction500
...
args=" -START_MOI 1 -FILE_NAME _Parasites25extinction500 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 1.0 -SAFE_TIME 25 -DATA_INT 10 -UPDATES 1550 -EXTINCTION_FREQUENCY 500"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites25extinction500.sh