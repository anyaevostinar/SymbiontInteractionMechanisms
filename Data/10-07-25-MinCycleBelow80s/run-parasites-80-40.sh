...
args=" -START_MOI 1 -FILE_NAME _Parasites-80-40 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.0 -HOST_MIN_CYCLES_BEFORE_REPRO 80 -SYM_MIN_CYCLES_BEFORE_REPRO 40"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-80-40.sh