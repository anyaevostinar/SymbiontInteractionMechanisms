...
## Job name settings
#SBATCH --job-name=sp-diff
#SBATCH -o sp-diff%A_%a.out
...
cd /Accounts/vostinar/SymbiontInteractionMechanisms/Data/8-20-25-StressUpdates
...
cp /Accounts/vostinar/SymbiontInteractionMechanisms/Data/8-20-25-StressUpdates/SymSettings.cfg .
