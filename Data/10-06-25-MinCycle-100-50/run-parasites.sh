...
cd /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-06-25-MinCycle-100-50
...
cp /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-06-25-MinCycle-100-50/SymSettings.cfg .
