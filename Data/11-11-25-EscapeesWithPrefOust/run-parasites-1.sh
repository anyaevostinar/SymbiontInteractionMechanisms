...
cd /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/11-11-25-EscapeesWithPrefOust
mkdir Parasites-1
cd Parasites-1
...
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/11-11-25-EscapeesWithPrefOust/SymSettings.cfg .
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Parasites-1 -PARASITE_NUM_OFFSPRING_ON_STRESS_INTERACTION 1"
