...
args=" -START_MOI 1 -FILE_NAME _Parasites-1 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.0 -PARASITE_NUM_OFFSPRING_ON_STRESS_INTERACTION 1"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-1.sh