...
cd /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/10-29-25-EscapeesWithPrefOust
mkdir Parasites-2
cd Parasites-2
...
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/Data/10-29-25-EscapeesWithPrefOust/SymSettings.cfg .
cp /Accounts/tuckerd/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Parasites-2 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.0 -PARASITE_NUM_OFFSPRING_ON_STRESS_INTERACTION 2"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-2.sh