...
cd /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-06-25-MinCycle-100-25
...
cp /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-06-25-MinCycle-100-25/SymSettings.cfg .
