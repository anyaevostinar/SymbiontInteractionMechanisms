...
args=" -START_MOI 1 -FILE_NAME _Mutualists1k -SYMBIONT_TYPE 0 -VERTICAL_TRANSMISSION 1.0 -EXTINCTION_FREQUENCY 1000"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-mutualists1k.sh