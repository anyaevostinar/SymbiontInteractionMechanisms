...
args=" -START_MOI 1 -FILE_NAME _Parasites1k -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.0 -EXTINCTION_FREQUENCY 1000"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites1k.sh