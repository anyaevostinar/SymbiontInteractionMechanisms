...
args=" -START_MOI 0 -FILE_NAME _NoSyms750 -EXTINCTION_FREQUENCY 750"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-nosyms750.sh