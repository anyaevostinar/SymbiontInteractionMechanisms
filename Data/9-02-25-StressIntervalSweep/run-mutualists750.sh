...
args=" -START_MOI 1 -FILE_NAME _Mutualists750 -SYMBIONT_TYPE 0 -VERTICAL_TRANSMISSION 1.0 -EXTINCTION_FREQUENCY 750"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-mutualists750.sh