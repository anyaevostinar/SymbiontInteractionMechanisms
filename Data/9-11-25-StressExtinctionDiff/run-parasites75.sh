...
args=" -START_MOI 1 -FILE_NAME _Parasites75 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 1.0 -SAFE_TIME 10 -DATA_INT 10 -UPDATES 1000 -EXTINCTION_FREQUENCY 75"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites75.sh