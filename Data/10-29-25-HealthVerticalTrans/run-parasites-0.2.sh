...
cp /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-29-25-HealthVerticalTrans/SymSettings.cfg .
cp /Accounts/zhange2/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Parasites-0.2 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.2"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-0.2.sh