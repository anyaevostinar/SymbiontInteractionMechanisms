...
cd /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-29-25-HealthVerticalTrans
mkdir Parasites-0.1
cd Parasites-0.1
...
cp /Accounts/zhange2/SymbiontInteractionMechanisms/Data/10-29-25-HealthVerticalTranss/SymSettings.cfg .
