...
args=" -START_MOI 1 -FILE_NAME _Parasites-0.8 -SYMBIONT_TYPE 1 -VERTICAL_TRANSMISSION 0.8"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-0.8.sh