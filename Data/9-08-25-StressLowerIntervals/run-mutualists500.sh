...
cp /Accounts/mendozac/SymbiontInteractionMechanisms/Data/9-08-25-StressLowerDeathProb/SymSettings.cfg .
cp /Accounts/mendozac/SymbiontInteractionMechanisms/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -FILE_NAME _Mutualists500 -SYMBIONT_TYPE 0 -VERTICAL_TRANSMISSION 1.0 -EXTINCTION_FREQUENCY 500"
