...
metafolder = '../../Data/9-09-25-StressDiffDeathChance/'


folders = ["Parasites40","Parasites50","Parasites60","Parasites55"]
partners = ["Host", "Sym"]
...
for t in folders:
    for r in reps:
        if (t=="Parasites55"):
            fname = metafolder +t+"/"+str(r)+"/" + "Tasks_Parasites50" +"_SEED" + str(r)+ ".data"
        else:
