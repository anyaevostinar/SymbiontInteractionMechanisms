...
metafolder = '../../Data/9-12-25-StressDiffFreq-Time/'


folders = ["Parasites200Safe1000", "Parasites200Safe1500", "Parasites150Safe1000", "Parasites150Safe1500"]
partners = ["Host", "Sym"]
...
for t in folders:
    for r in reps:
        if (t=="Parasites400second"):
            fname = metafolder +t+"/"+str(r)+"/" + "Tasks_Parasites400" +"_SEED" + str(r)+ ".data"
        else:
